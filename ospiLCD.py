...
"""
################################################
url = ("http://"+osAddress+":"+str(osPort)+"/ja?pw="+md5hash)

#print 'OpenSprinkler PI LCD script'
try:
...
def get_data(url):
	...
	#print data
	variableset = json.loads(data, object_hook=lambda d: namedtuple('X', d.keys())(*d.values()))
	return variableset
...
lcd = i2c.CharLCD(i2c_expander='PCF8574', address=0x27, port=1,
              cols=LCDcols, rows=LCDrows, dotsize=8,
              charmap='A02',
